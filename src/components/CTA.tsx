  ...
  return (
    <section className="py-12 md:py-24 gradient-animated relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 right-0 h-10 md:h-16 lg:h-20 rotate-180">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none" className="w-full h-full rotate-180">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-6xl mx-auto animate-fade-in">
          <div className="flex flex-col gap-4 md:gap-8 items-center mb-4 md:mb-8">
            ...
            <div className="text-center">
              ...
              <div className="inline-flex gap-1 md:gap-3 bg-black/30 backdrop-blur-sm rounded-xl md:rounded-2xl p-3 md:p-6">
                <div className="text-center">
                  <div className="text-2xl md:text-4xl lg:text-5xl font-bold text-white mb-1">{String(timeLeft.days).padStart(2, '0')}</div>
                ...
                <div className="text-center">
                  <div className="text-2xl md:text-4xl lg:text-5xl font-bold text-white mb-1">{String(timeLeft.hours).padStart(2, '0')}</div>
                  <div className="text-[10px] md:text-xs uppercase text-white/70">HRS</div>
                </div>
                <div className="text-2xl md:text-4xl lg:text-5xl font-bold text-white flex items-center">:</div>
                <div className="text-center">
                  <div className="text-2xl md:text-4xl lg:text-5xl font-bold text-white mb-1">{String(timeLeft.minutes).padStart(2, '0')}</div>
                  <div className="text-[10px] md:text-xs uppercase text-white/70">MIN</div>
                </div>
                <div className="text-2xl md:text-4xl lg:text-5xl font-bold text-white flex items-center">:</div>
                <div className="text-center">
                  <div className="text-2xl md:text-4xl lg:text-5xl font-bold text-white mb-1">{String(timeLeft.seconds).padStart(2, '0')}</div>
          ...
          <div className="text-center px-2">
            <Button
            size="lg"
            className="bg-accent text-accent-foreground hover:bg-[#ffc700] font-bold text-sm md:text-xl px-6 md:px-12 py-5 md:py-8 rounded-full shadow-2xl animate-pulse-cta mb-4 md:mb-8 w-full md:w-auto max-w-full whitespace-normal"
          >
            Quero Acelerar Minha Carreira Agora! <ArrowRight className="ml-2 md:ml-3 h-5 w-5 md:h-6 md:w-6 flex-shrink-0" />
          </Button>
